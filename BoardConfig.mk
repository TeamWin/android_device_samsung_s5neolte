...
BOARD_MKBOOTIMG_ARGS := --ramdisk_offset  0x11000000 --dt device/samsung/s5neolte/dtb --tags_offset 0x10000100
...
TARGET_RECOVERY_INITRC := device/samsung/s5neolte/init.rc
